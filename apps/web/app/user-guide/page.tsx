  ...
  return (
    <main className="page explain-page">
      <section className="card">
        <p className="badge">Student Guide</p>
        <h1>How To Use This App (9th Grade Friendly)</h1>
      ...
      <section className="card">
        <h2>3) Identity Explained Like A School Locker Key</h2>
        <p>
        ...
        <div className="guide-grid">
          ...
          <div className="guide-item">
            ...
            <p>
              ...
              sessions are still in database, but not visible to this new identity.
            </p>
          </div>
        </div>
        <p className="identity-warning">
          Important: Do not create a new identity right before class presentation if you need
          your old saved session list.
        </p>
      </section>

      <section className="card">
        <h2>4) How To Explain This To A Teacher</h2>
        <ul>
